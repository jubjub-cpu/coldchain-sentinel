...
function shell() {
  workspace.innerHTML = `<div class="console-shell">
    ...
    <section class="operations" aria-labelledby="operation-heading">
      ...
      <section class="telemetry-section" aria-labelledby="telemetry-heading"><div class="panel-heading"><div><p class="eyebrow">Raw synthetic evidence</p><h3 id="telemetry-heading">Reading ledger</h3></div><span>Newest first</span></div><div class="table-wrap" tabindex="0" aria-label="Telemetry reading ledger"><table><thead><tr><th>Time</th><th>Stage</th><th>Temp</th><th>Humidity</th><th>Battery</th><th>Signal</th><th>Door</th></tr></thead><tbody id="telemetry-body"></tbody></table></div></section>
